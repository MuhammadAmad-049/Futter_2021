...
class MyApp extends StatelessWidget {
  ...
  static const appTitle = 'Password';
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
                  ...
                  builder: (context) {
                    return Form(
                      ...
                      child: AlertDialog(
                          ...
                          title: Text(' please enter Security code'),
                          content: TextField(
                            controller: code,
                            ...
                            FlatButton(
                                ...
                                onPressed: () {
                                  showDialog(
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                          title: Text('Please fill the the boxes according to requirements'),
                                          content: Column(
                                            crossAxisAlignment: CrossAxisAlignment.stretch,
                                            //position
            ...
            ListTile(
              title: const Text('Retrivel the Password',
                style: TextStyle(
                  color: Colors.red,
                  fontSize: 20.0,
                ),),
